...
- [ ] Player stat cards with PAC/SHO/PAS/DRI/DEF/PHY breakdown
- [ ] Animation: player disc flies from list to pitch slot on draft
- [ ] Sound effects (optional, with toggle)
- [ ] Mobile: swipe between squad list and pitch panels

---

## Milestone 4 — Quality & Documentation ✅ Complete (for now)
