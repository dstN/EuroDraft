  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="space-y-3">
          ...
          <input
            ...
            class="w-full px-4 py-2.5 rounded-xl border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-800/80 text-zinc-900 dark:text-white font-bold text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
          >
          ...
          <div class="flex flex-wrap gap-1.5 pt-1">
            <button
              ...
              :class="teamNameInput === preset
                ...
                : 'bg-zinc-100 dark:bg-zinc-800/60 border-zinc-200 dark:border-white/5 text-zinc-600 dark:text-zinc-400 hover:text-white'"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
      <button
        ...
        :key="formation.id"
        type="button"
        class="surface-card p-5 space-y-4 group text-left cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:shadow-[0_10px_30px_rgba(16,185,129,0.15)] active:scale-[0.98]"
